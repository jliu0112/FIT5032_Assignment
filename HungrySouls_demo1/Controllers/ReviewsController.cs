...
namespace HungrySouls_demo1.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewID,ClientID,RatingLevel,Comments")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewID,ClientID,RatingLevel,Comments")] Review review)
        {
            if (ModelState.IsValid)
            {
